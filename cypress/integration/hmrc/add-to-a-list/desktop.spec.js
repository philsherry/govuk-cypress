...
beforeEach(() => {
  ...
  describe('sets up aliases for example 1', () => {
    ...
    cy.get('@example-1').get('@radio1').get('@radioLabel').as('radio1__label')

    cy.get('@example-1').get('@radio1').get('@radioInput').as('radio1__input')

    cy.get('@example-1').get('@radio2').get('@radioLabel').as('radio2__label')

    cy.get('@example-1').get('@radio2').get('@radioInput').as('radio2__input')
